...
The foundation package is a pure CDS reuse model providing common types like e.g. Currency, Unit of Measure, etc., which are frequently used in business applications.
